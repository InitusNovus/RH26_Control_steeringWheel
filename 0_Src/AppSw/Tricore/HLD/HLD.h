 ...
 *
 *
 ****** Version History: HLD_LIGHT *****
 * For side controllers (Appkit TC237) of RH26
 * V_0.1.0: Branched out from HLD_RH26_SB275_V_0.1.0
 * V_0.2.0: Renew GtmTomPwm
 * V_0.3.0: Vadc Module
 *
 * Todo Compatability TC237 and TC275
 *
 *
 */
/******************************************************************************/
