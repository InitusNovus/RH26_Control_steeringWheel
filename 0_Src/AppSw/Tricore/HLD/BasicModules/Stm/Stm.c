...
void Stm_Led_init (void)
{
	...
	IfxPort_setPinMode(LED107.port, LED107.pinIndex, IfxPort_Mode_outputPushPullGeneral);
	...
	IfxPort_setPinState(LED107.port, LED107.pinIndex, IfxPort_State_high);
	IfxPort_setPinState(LED108.port, LED108.pinIndex, IfxPort_State_high);
	IfxPort_setPinState(LED109.port, LED109.pinIndex, IfxPort_State_high);
	IfxPort_setPinState(LED110.port, LED110.pinIndex, IfxPort_State_high);
...
#elif HLD_BOARD == HLD_BOARD_AK237
	if(g_Stm.LedState.B.Led107 == TRUE)
	{
		IfxPort_setPinState (LED107.port, LED107.pinIndex, IfxPort_State_low);
	}
	else
	{
		IfxPort_setPinState (LED107.port, LED107.pinIndex, IfxPort_State_high);
...
/*
	if(g_Stm.LedState.B.Led108 == TRUE)
	{
		IfxPort_setPinState (LED108.port, LED108.pinIndex, IfxPort_State_low);
	}
	else
	{
		IfxPort_setPinState (LED108.port, LED108.pinIndex, IfxPort_State_high);
	...
	if(g_Stm.LedState.B.Led109 == TRUE)
	{
		IfxPort_setPinState (LED109.port, LED109.pinIndex, IfxPort_State_low);
	}
	else
	{
		IfxPort_setPinState (LED109.port, LED109.pinIndex, IfxPort_State_high);
	...
	if(g_Stm.LedState.B.Led110 == TRUE)
	{
		IfxPort_setPinState (LED110.port, LED110.pinIndex, IfxPort_State_low);
	}
	else
	{
		IfxPort_setPinState (LED110.port, LED110.pinIndex, IfxPort_State_high);
