...
.Ltext0:
.section .text.CurrentSensing_init,"ax",@progbits
	.align 1
	.global	CurrentSensing_init
	.type	CurrentSensing_init, @function
CurrentSensing_init:
.LFB691:
	.file 1 "0_Src/AppSw/Tricore/AccumulatorManager/CurrentSensing/CurrentSensing.c"
	.loc 1 40 0
	sub.a	%SP, 32
.LCFI0:
	.loc 1 42 0
...
.LVL0:
	...
	mov	%d2, 1
	.loc 1 55 0
	movh.a	%a15, hi:CurrentSensing
	.loc 1 44 0
	addi	%d15, %d15, -23075
	.loc 1 47 0
	st.b	[%SP] 8, %d2
	.loc 1 55 0
	lea	%a15, [%a15] lo:CurrentSensing
	.loc 1 50 0
	movh	%d2, hi:HLD_Vadc_AN1_G0CH1_X102_11
	addi	%d2, %d2, lo:HLD_Vadc_AN1_G0CH1_X102_11
	.loc 1 44 0
	st.w	[%SP] 12, %d15
	.loc 1 53 0
	mov	%d8, 0
	...
	st.w	[%SP] 28, %d8
	.loc 1 55 0
	call	AdcSensor_initSensor
.LVL1:
	.loc 1 58 0
	movh	%d2, hi:HLD_Vadc_AN2_G0CH2_X102_10
	addi	%d2, %d2, lo:HLD_Vadc_AN2_G0CH2_X102_10
	.loc 1 63 0
	lea	%a4, [%a15] 48
	lea	%a5, [%SP] 4
	.loc 1 58 0
...
.LVL2:
.LFE691:
	.size	CurrentSensing_init, .-CurrentSensing_init
.section .text.CurrentSensing_run,"ax",@progbits
	.align 1
	.global	CurrentSensing_run
	.type	CurrentSensing_run, @function
CurrentSensing_run:
.LFB692:
	.loc 1 69 0
.LVL3:
...
.LBE2:
.LFE692:
	.size	CurrentSensing_run, .-CurrentSensing_run
	.global	CurrentSensing
.section .bss.CurrentSensing,"aw",@nobits
	.align 2
	.type	CurrentSensing, @object
	.size	CurrentSensing, 100
CurrentSensing:
	.zero	100
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/AppSw/Tricore/AccumulatorManager/CurrentSensing/CurrentSensing.c"
...
.LASF45:
	...
	.extern	HLD_Vadc_AN2_G0CH2_X102_10,STT_OBJECT,2
	.extern	AdcSensor_initSensor,STT_FUNC,0
	.extern	HLD_Vadc_AN1_G0CH1_X102_11,STT_OBJECT,2
