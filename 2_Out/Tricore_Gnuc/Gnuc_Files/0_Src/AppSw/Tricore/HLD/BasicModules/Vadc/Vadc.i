# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c"
# 1 "C:\\Google drive\\RH_Workspace\\_AccumuatorManager_TC237//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c"
# 12 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c"
...
# 13 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.h" 1
# 14 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/Fix/AdcForceStart.h" 1
# 20 "0_Src/AppSw/Tricore/HLD/Fix/AdcForceStart.h"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Vadc/Adc/IfxVadc_Adc.h" 1
# 21 "0_Src/AppSw/Tricore/HLD/Fix/AdcForceStart.h" 2
# 49 "0_Src/AppSw/Tricore/HLD/Fix/AdcForceStart.h"
extern void HLD_AdcForceStart(IfxVadc_Adc_Group* adcGroup);
# 15 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c" 2
# 33 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c"
HLD_Vadc_t HLD_Vadc;
...
# 70 "0_Src/AppSw/Tricore/HLD/BasicModules/Vadc/Vadc.c"
...
void HLD_Vadc_initChannel(HLD_Vadc_Channel* channel, HLD_Vadc_Channel_Config* config)
{
 if(config->channelIn != ((void *)0))
 {
  ...
  if(config->lpf.activated)
  {
   ...
   channel->isLpfActivatied = 1;
  }
  else
  {
   channel->isLpfActivatied = 0;
  }
...
{
 config->channelIn = ((void *)0);
 config->lpf.activated = 0;
}
...
void HLD_Vadc_getData(HLD_Vadc_Data* data, HLD_Vadc_Channel* channel)
{
 ...
 {
  data->voltage = Ifx_LowPassPt1F32_do(&channel->lpf, 5.0 * (data->rawData = IfxVadc_Adc_getResult(&channel->channel).B.RESULT) / ((float32)4095));
 }
 else
 {
  data->voltage = 5.0 * (data->rawData = IfxVadc_Adc_getResult(&channel->channel).B.RESULT) / ((float32)4095);
 }
