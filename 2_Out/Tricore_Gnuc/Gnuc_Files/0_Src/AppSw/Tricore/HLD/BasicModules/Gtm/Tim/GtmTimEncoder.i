# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c"
# 1 "C:\\Google drive\\RH_Workspace\\_AccumuatorManager_TC237//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c"
# 12 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c"
...
# 13 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c" 2
...
# 14 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c" 2
# 28 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c"
typedef struct
{
 float32 speed;
}HLD_GtmTimEncoder_t;
...
# 55 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTimEncoder.c"
void HLD_GtmTimEncoder_run_1ms(void)
{
 HLD_GtmTimEncoder.speed = 2*(3.1415926535897932384626433832795f)*HLD_GtmTim.ch[0].data.pulseHz/(900.0);
}

float32 HLD_GtmTimEncoder_getSpeed(void)
{
 if((((sizeof(HLD_GtmTimEncoder.speed) == sizeof(float)) ? __fpclassifyf(HLD_GtmTimEncoder.speed) : __fpclassifyd(HLD_GtmTimEncoder.speed)) == 1))
  return 0;
 else
