...
.Ltext0:
	...
	.global	__subdf3
	.global	__fixunsdfsi
.section .text.HLD_GtmTomServo_servoRun,"ax",@progbits
	.align 1
	.type	HLD_GtmTomServo_servoRun, @function
HLD_GtmTomServo_servoRun:
.LFB695:
	.file 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Servo/GtmTomServo.c"
	.loc 1 194 0
.LVL0:
	.loc 1 197 0
	ld.w	%d4, [%a4] 68
...
.LVL11:
.LFE695:
	.size	HLD_GtmTomServo_servoRun, .-HLD_GtmTomServo_servoRun
.section .text.HLD_GtmTomServo_servoInit.constprop.0,"ax",@progbits
	.align 1
	.type	HLD_GtmTomServo_servoInit.constprop.0, @function
HLD_GtmTomServo_servoInit.constprop.0:
.LFB698:
	.loc 1 151 0
.LVL12:
	.loc 1 153 0
...
.LVL18:
.LFE698:
	.size	HLD_GtmTomServo_servoInit.constprop.0, .-HLD_GtmTomServo_servoInit.constprop.0
.section .text.HLD_GtmTomServo_init,"ax",@progbits
	.align 1
	.global	HLD_GtmTomServo_init
	.type	HLD_GtmTomServo_init, @function
...
.LVL19:
	...
	st.w	[%SP] 8, %d15
	.loc 1 115 0
	movh	%d15, hi:IfxGtm_TOM0_7_TOUT32_P33_10_OUT
	addi	%d15, %d15, lo:IfxGtm_TOM0_7_TOUT32_P33_10_OUT
	st.w	[%SP] 16, %d15
	.loc 1 116 0
	lea	%a5, [%SP] 40
	movh	%d15, 16480
	st.w	[+%a5]-40, %d15
	.loc 1 117 0
	movh.a	%a4, hi:HLD_servoSteering
.LBB6:
.LBB7:
	.loc 1 188 0
	mov	%d8, 0
...
.LBE6:
	.loc 1 117 0
	lea	%a4, [%a4] lo:HLD_servoSteering
	mov.aa	%a5, %SP
.LBB9:
.LBB8:
	.loc 1 188 0
...
.LBE9:
	.loc 1 117 0
	call	HLD_GtmTomServo_servoInit.constprop.0
.LVL20:
.LBB10:
.LBB11:
	.loc 1 186 0
...
.LBE10:
	.loc 1 124 0
	movh	%d15, hi:IfxGtm_TOM0_9_TOUT10_P00_1_OUT
	addi	%d15, %d15, lo:IfxGtm_TOM0_9_TOUT10_P00_1_OUT
	st.w	[%SP] 36, %d15
	.loc 1 125 0
	lea	%a5, [%SP] 40
.LVL21:
	movh	%d15, 16776
	.loc 1 126 0
	movh.a	%a4, hi:HLD_servoInfraRed
	.loc 1 125 0
	st.w	[+%a5]-20, %d15
.LVL22:
	.loc 1 126 0
	lea	%a4, [%a4] lo:HLD_servoInfraRed
.LBB13:
.LBB12:
	.loc 1 188 0
	st.b	[%SP] 32, %d8
...
.LBE13:
	.loc 1 126 0
	j	HLD_GtmTomServo_servoInit.constprop.0
.LVL23:
.LFE691:
	.size	HLD_GtmTomServo_init, .-HLD_GtmTomServo_init
.section .text.HLD_GtmTomServo_run,"ax",@progbits
	.align 1
	.global	HLD_GtmTomServo_run
	.type	HLD_GtmTomServo_run, @function
HLD_GtmTomServo_run:
.LFB692:
	.loc 1 130 0
	.loc 1 147 0
	movh.a	%a4, hi:HLD_servoSteering
	lea	%a4, [%a4] lo:HLD_servoSteering
	call	HLD_GtmTomServo_servoRun
.LVL24:
	.loc 1 148 0
	movh.a	%a4, hi:HLD_servoInfraRed
	lea	%a4, [%a4] lo:HLD_servoInfraRed
	j	HLD_GtmTomServo_servoRun
.LVL25:
.LFE692:
	.size	HLD_GtmTomServo_run, .-HLD_GtmTomServo_run
.section .text.HLD_GtmTomServo_setAngle,"ax",@progbits
	.align 1
	.global	HLD_GtmTomServo_setAngle
	.type	HLD_GtmTomServo_setAngle, @function
HLD_GtmTomServo_setAngle:
.LFB696:
	.loc 1 212 0
.LVL26:
	.loc 1 213 0
	...
	ret
.LFE696:
	.size	HLD_GtmTomServo_setAngle, .-HLD_GtmTomServo_setAngle
.section .text.HLD_GtmTomServo_getAngle,"ax",@progbits
	.align 1
	.global	HLD_GtmTomServo_getAngle
	.type	HLD_GtmTomServo_getAngle, @function
HLD_GtmTomServo_getAngle:
.LFB697:
	.loc 1 217 0
.LVL27:
	.loc 1 219 0
	...
	ret
.LFE697:
	.size	HLD_GtmTomServo_getAngle, .-HLD_GtmTomServo_getAngle
	.global	HLD_servoInfraRed
.section .bss.HLD_servoInfraRed,"aw",@nobits
	.align 2
	.type	HLD_servoInfraRed, @object
	.size	HLD_servoInfraRed, 88
HLD_servoInfraRed:
	.zero	88
	.global	HLD_servoSteering
.section .bss.HLD_servoSteering,"aw",@nobits
	.align 2
	.type	HLD_servoSteering, @object
	.size	HLD_servoSteering, 88
HLD_servoSteering:
	.zero	88
...
.Letext0:
	...
	.file 18 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Servo/GtmTomServo.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Servo/GtmTomServo.c"
	...
	.byte	0
	.uleb128 0x3
	.string	"HLD_servo_Config"
	.byte	0x1
	.byte	0x26
	.uaword	0xcba4
	.uleb128 0x23
	.string	"HLD_GtmTomServo_servoInitConfig"
	.byte	0x1
	.byte	0xb8
	.byte	0x1
	.byte	0x1
	...
	.uaword	0xcbef
	.uleb128 0x23
	.string	"HLD_GtmTomServo_servoInit"
	.byte	0x1
	.byte	0x97
	.byte	0x1
	.byte	0x1
	...
	.uaword	0xc942
	.uleb128 0x27
	.string	"HLD_GtmTomServo_servoRun"
	.byte	0x1
	.byte	0xc1
	.byte	0x1
	.uaword	.LFB695
	...
	.byte	0x5
	.byte	0x3
	.uaword	HLD_servoInfraRed
	.byte	0
	.byte	0
	.uleb128 0x30
	.byte	0x1
	.string	"HLD_GtmTomServo_run"
	.byte	0x1
	.byte	0x81
	.byte	0x1
	.uaword	.LFB692
	...
	.uleb128 0x30
	.byte	0x1
	.string	"HLD_GtmTomServo_setAngle"
	.byte	0x1
	.byte	0xd3
	.byte	0x1
	.uaword	.LFB696
	...
	.uleb128 0x35
	.byte	0x1
	.string	"HLD_GtmTomServo_getAngle"
	.byte	0x1
	.byte	0xd8
	.byte	0x1
	.uaword	0x23f
...
.LASF106:
	.string	"CTRL"
	.extern	IfxGtm_TOM0_9_TOUT10_P00_1_OUT,STT_OBJECT,20
