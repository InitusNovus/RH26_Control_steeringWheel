# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c"
# 1 "C:\\Google drive\\RH_Workspace\\_AccumuatorManager_TC237//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c"
# 11 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h" 1
# 14 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper_note.h" 1
# 11 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper_note.h"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h" 1
# 12 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper_note.h" 2
# 15 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h" 2
...
# 16 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h" 2
# 29 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h"
typedef enum
{
 end,
 repeat,
...
# 105 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/../../../Gtm/Tom/Beeper/GtmTomBeeper.h"
extern void HLD_GtmTomBeeper_start (note_t* target);
# 12 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c" 2
...
# 14 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c" 2
# 30 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c"
typedef struct
{
 boolean on;
 float32 frequency;
...
note_t Beep_off[] = {{end, rest, 0}};
note_t Beep_pattern1[] = {{note_thirtysecond, note_C6, 1}, {end, rest, 0}};
note_t Beep_pattern2[] = {{note_thirtysecond, note_C5, 1}, {end, rest, 0}};
note_t Beep_pattern3[] = {{note_sixteenth, note_E6, 0},{note_sixteenth, note_E6, 0},{note_sixteenth, note_E6, 0}, {end, rest, 0}};
note_t Beep_pattern4[] = {{note_thirtysecond, note_G5, 1},{note_thirtysecond, note_A5, 1},{note_thirtysecond, note_B5, 1},{note_thirtysecond, note_C6, 1},{note_thirtysecond, note_D6, 1},{end, rest, 0}};
note_t Beep_pattern5[] = {{note_thirtysecond, note_D5, 1},{note_thirtysecond, note_C5, 1},{note_thirtysecond, note_B5, 1},{note_thirtysecond, note_A6, 1},{note_thirtysecond, note_G6, 1},{end, rest, 0}};
note_t Beep_pattern6[] = {{note_thirtysecond, note_G5, 1},{note_thirtysecond, note_B5, 1},{note_thirtysecond, note_D6, 1},{end, rest, 0}};
note_t Beep_pattern7[] = {{note_thirtysecond, note_D5, 1},{note_thirtysecond, note_B5, 1},{note_thirtysecond, note_G6, 1},{end, rest, 0}};
note_t Beep_pattern8[] = {{note_sixteenth, note_A6, 1},{end, rest, 0}};
note_t Beep_pattern9[] = {{note_sixteenth, note_As5, 1},{end, rest, 0}};
note_t Beep_pattern10[] = {{note_sixteenth, note_F5, 1},{end, rest, 0}};




static void getBeats (note_t note);
static void getPitch (note_t note);
# 103 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tom/Beeper/GtmTomBeeper.c"
static void HLD_GtmTomBeeper_runInternal(void);
static void HLD_GtmTomBeeper_play(void);
...
void HLD_GtmTomBeeper_play (void)
{
 ...
 if((g_Music.isend == 0))
 {
  ...
  if((g_Music.pitch < 0)||(g_Music.isend == 1))
  {
   HLD_GtmTomBeeper.volume = 0;
  }
  else
  {
   if((g_Music.beat_counter > g_Music.beats - 50)&&(g_Music.tie == 0))
   {
    HLD_GtmTomBeeper.volume = 0;
   }
   else
...
static void getBeats (note_t note)
{
 switch(note.beat)
 {
 case note_whole: g_Music.beats = (4*(1000*60/(140))); break;
 case note_half: g_Music.beats = (2*(1000*60/(140))); break;
 case note_quarter: g_Music.beats = ((1000*60/(140))); break;
 case note_eighth: g_Music.beats = ((1000*60/(140))/2); break;
 case note_sixteenth: g_Music.beats = ((1000*60/(140))/4); break;
 case note_thirtysecond: g_Music.beats = ((1000*60/(140))/8); break;
 case end: g_Music.isend = 1 ; break;
...
static void getPitch (note_t note)
{
 ...
 case note_C5: g_Music.pitch = (523.251131); break;
 case note_Cs5: g_Music.pitch = (554.365262); break;
 case note_D5: g_Music.pitch = (587.329536); break;
 case note_Ds5: g_Music.pitch = (622.253967); break;
 case note_E5: g_Music.pitch = (659.255114); break;
 case note_F5: g_Music.pitch = (698.456463); break;
 case note_Fs5: g_Music.pitch = (739.988845); break;
 case note_G5: g_Music.pitch = (783.990872); break;
 case note_Gs5: g_Music.pitch = (830.609395); break;
 case note_A5: g_Music.pitch = (880.0); break;
 case note_As5: g_Music.pitch = (932.327523); break;
 case note_B5: g_Music.pitch = (987.766603); break;
 case note_C6: g_Music.pitch = (1046.502261); break;
 case note_Cs6: g_Music.pitch = (1108.730524); break;
 case note_D6: g_Music.pitch = (1174.659072); break;
 case note_Ds6: g_Music.pitch = (1244.507935); break;
 case note_E6: g_Music.pitch = (1318.510228); break;
 case note_F6: g_Music.pitch = (1396.912926); break;
 case note_Fs6: g_Music.pitch = (1479.977691); break;
 case note_G6: g_Music.pitch = (1567.981744); break;
 case note_Gs6: g_Music.pitch = (1661.218790); break;
 case note_A6: g_Music.pitch = (1760.0); break;
 case note_C7: g_Music.pitch = (2093.004522); break;
 }
}
...
static void HLD_GtmTomBeeper_runInternal(void)
{
 ...
 if(g_GtmTomBeeper.on == 1)
 {
  IfxGtm_Tom_Timer_disableUpdate((&g_GtmTomBeeper.driver));
  ...
  IfxGtm_Tom_Timer_applyUpdate((&g_GtmTomBeeper.driver));
