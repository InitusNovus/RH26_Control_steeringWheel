# 1 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
...
# 9 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 10 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 11 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
# 20 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
...
# 21 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 22 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC23A/_Reg/IfxQspi_bf.h" 1
# 23 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 25 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 26 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/LCD/font.h" 1
# 16 "0_Src/AppSw/Tricore/HLD/LCD/font.h"
...
# 27 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
...
# 29 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c" 2
# 95 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
...
static void init_qspi0(void)
{
 ...
 (*(volatile Ifx_QSPI_GLOBALCON *)0xF0001C10u).U = (15 << (10u))
      | (1 << (9u));
 (*(volatile Ifx_QSPI_GLOBALCON1 *)0xF0001C14u).U = (4 << (20u))
      | (1 << (15u))
      | (1 << (12u))
      | (1 << (11u))
      | (1 << (10u))
 ...
 (*(volatile Ifx_QSPI_SSOC *)0xF0001C48u).U = ((3 << 8) << (16u));
 ...
 (*(volatile Ifx_QSPI_ECON *)0xF0001C20u).U = (1 << (13u))
      | (0 << (10u))
 ...
 (*(volatile Ifx_QSPI_ECON *)0xF0001C24u).U = (1 << (10u))
      | (1 << (8u))
      | ((2 - 1) << (6u))
      | ((25 - 1) << (0u));


 (*(volatile Ifx_QSPI_ECON *)0xF0001C3Cu).U = (1 << (10u))
      | (1 << (8u))
      | ((2 - 1) << (6u))
      | ((1 - 1) << (0u));
...
static void wr_cmd_endless(unsigned int cmd)
{
 ...
 while ((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.TXFIFOLEVEL > (4 - 3))
  ;
 (*(volatile Ifx_QSPI_BACONENTRY *)0xF0001C60u).U = (8 << (28u))
      | ((0x1u) << (21u))
      | ((10-1) << (23u))
      | (1 << (10u));
 ...
 (*(volatile Ifx_QSPI_MIXENTRY *)0xF0001C5Cu).U = (8 << (28u))
      | ((0x1u) << (21u))
      | ((16-1) << (23u))
      | (1 << (10u));
}
...
static void wr_end_transfer(void)
{
 ...
 (*(volatile Ifx_QSPI_BACONENTRY *)0xF0001C60u).U = (15 << (28u))
      | ((0x1u) << (21u))
      | ((9-1) << (23u))
      | (1 << (10u))
      | ((0x1u) << (0u));
...
# 439 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
void GLCD_init(void)
{

 (*(volatile Ifx_P_OUT *)0xF003C000u).B.P13 = 0;
 (*(volatile Ifx_P_IOCR12 *)0xF003C01Cu).B.PC13 = 0x10;


 init_qspi0();

 waitTime(50*(TimeConst[(5)]));
...
# 736 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
...
static void GLCD_drawChar_inv(unsigned int x, unsigned int y, const unsigned short *c)
{
 ...
 glcd_set_position(Xaddress, y - 24 +1);
...
# 944 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
...
int GLCD_getLineNo(unsigned int line)
{
 switch (line)
 {
  case 0: return ((((240 / 24) - (0)) * 24) - 1);
  case 1: return ((((240 / 24) - (1)) * 24) - 1);
  case 2: return ((((240 / 24) - (2)) * 24) - 1);
  case 3: return ((((240 / 24) - (3)) * 24) - 1);
  case 4: return ((((240 / 24) - (4)) * 24) - 1);
  case 5: return ((((240 / 24) - (5)) * 24) - 1);
  case 6: return ((((240 / 24) - (6)) * 24) - 1);
  case 7: return ((((240 / 24) - (7)) * 24) - 1);
  case 8: return ((((240 / 24) - (8)) * 24) - 1);
  case 9: return ((((240 / 24) - (9)) * 24) - 1);
  default: return -1;
 }
}
# 1105 "0_Src/AppSw/Tricore/HLD/LCD/glcd.c"
static unsigned int rd_ads7843(unsigned int cmd)
{
 ...
 (*(volatile Ifx_QSPI_BACONENTRY *)0xF0001C60u).U = (9 << (28u))
      | ((0x1u) << (21u))
      | ((8-1) << (23u))
      | (1 << (10u));

 (*(volatile Ifx_QSPI_DATAENTRY *)0xF0001C64u).U = cmd;
