# 1 "0_Src/AppSw/Tricore/HLD/Lcd.c"
# 1 "C:\\Google drive\\RH_Workspace\\_AccumuatorManager_TC237//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/Lcd.c"
# 12 "0_Src/AppSw/Tricore/HLD/Lcd.c"
...
# 27 "0_Src/AppSw/Tricore/HLD/HLD.h" 2
...
# 13 "0_Src/AppSw/Tricore/HLD/Lcd.c" 2
...
# 14 "0_Src/AppSw/Tricore/HLD/Lcd.c" 2





# 1 "0_Src/AppSw/Tricore/HLD/LCD_graphic/Background.h" 1





extern const unsigned short Background_image[];
# 20 "0_Src/AppSw/Tricore/HLD/Lcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/LCD_graphic/LR_buttons.h" 1





extern const unsigned short LR_buttons_image[];
# 21 "0_Src/AppSw/Tricore/HLD/Lcd.c" 2
# 37 "0_Src/AppSw/Tricore/HLD/Lcd.c"
typedef struct __attribute__((packed))
{
 float32* val;
 char* tag;
...
Lcd_t g_Lcd =
{
  ...
  .touch.x = (((3740 -210)*(320)/320) + 210),
  .touch.y = (((3740 -260)*(0)/240) + 260),
...
# 90 "0_Src/AppSw/Tricore/HLD/Lcd.c"
TouchButton_t startButton =
{
  .xmin = (((3740 -210)*(0)/320) + 210),
  .xmax = (((3740 -210)*(88-1)/320) + 210),
  .ymin = (((3740 -260)*(192)/240) + 260),
  .ymax = (((3740 -260)*(240-1)/240) + 260),
  .accum = 0
};
TouchButton_t stopButton =
{
  .xmin = (((3740 -210)*(232)/320) + 210),
  .xmax = (((3740 -210)*(320-1)/320) + 210),
  .ymin = (((3740 -260)*(192)/240) + 260),
  .ymax = (((3740 -260)*(240-1)/240) + 260),
  .accum = 0
};
...
{
  .xmin = (((3740 -210)*(0)/320) + 210),
  .xmax = (((3740 -210)*(24-1)/320) + 210),
  .ymin = (((3740 -260)*(0)/240) + 260),
  .ymax = (((3740 -260)*(24-1)/240) + 260),
  .accum = 0
};
TouchButton_t pageUpButton =
{
  .xmin = (((3740 -210)*(24)/320) + 210),
  .xmax = (((3740 -210)*(48-1)/320) + 210),
  .ymin = (((3740 -260)*(0)/240) + 260),
  .ymax = (((3740 -260)*(24-1)/240) + 260),
  .accum = 0
};
...
{
  .xmin = (((3740 -210)*(48)/320) + 210),
  .xmax = (((3740 -210)*(48+6*16-1)/320) + 210),
  .ymin = (((3740 -260)*(0)/240) + 260),
  .ymax = (((3740 -260)*(24-1)/240) + 260),
  .accum = 0
};

LcdData_t LcdData[3][7];



static void HLD_Lcd_clearInterface(void);
static inline __attribute__ ((always_inline)) void HLD_Lcd_drawLineH(uint16 xStart, uint16 yStart, uint16 length);
static inline __attribute__ ((always_inline)) void HLD_Lcd_drawLineV(uint16 xStart, uint16 yStart, uint16 length);
static void HLD_Lcd_clearChart(ArrayChart_t* arrayChart,unsigned short color);
...
void HLD_Lcd_init(void)
{
 ...
 GLCD_setTextColor(( (((((0x1d)) * (1 << ((5)))) >> 8) << ((11))) | (((((0x24)) * (1 << ((6)))) >> 8) << ((5))) | (((((0x75)) * (1 << ((5)))) >> 8) << ((0)))));



 GLCD_bitmap(0,0,48, 24,LR_buttons_image);

 GLCD_setTextColor(( (((((192)) * (1 << ((5)))) >> 8) << ((11))) | (((((192)) * (1 << ((6)))) >> 8) << ((5))) | (((((192)) * (1 << ((5)))) >> 8) << ((0)))));
 Lcd_sprintf_col(((((240 / 24) - (9)) * 24) - 1), 320-6*16, "V%d.%d.%d",0,3,0);
# 180 "0_Src/AppSw/Tricore/HLD/Lcd.c"
 GLCD_setTextColor(( (((((0)) * (1 << ((5)))) >> 8) << ((11))) | (((((0)) * (1 << ((6)))) >> 8) << ((5))) | (((((0)) * (1 << ((5)))) >> 8) << ((0)))));
 GLCD_setBackColor(( (((((255)) * (1 << ((5)))) >> 8) << ((11))) | (((((255)) * (1 << ((6)))) >> 8) << ((5))) | (((((255)) * (1 << ((5)))) >> 8) << ((0)))));
...
# 400 "0_Src/AppSw/Tricore/HLD/Lcd.c"
 }
}
...
static inline __attribute__ ((always_inline)) void HLD_Lcd_clearInterface(void)
{
 GLCD_clreaWindow(0,24,320,168,( (((((255)) * (1 << ((5)))) >> 8) << ((11))) | (((((255)) * (1 << ((6)))) >> 8) << ((5))) | (((((255)) * (1 << ((5)))) >> 8) << ((0)))));
}
