# 1 "0_Src/AppSw/Tricore/Main/SchedulerTask.c"
# 1 "C:\\Google drive\\RH_Workspace\\_AccumuatorManager_TC237//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Main/SchedulerTask.c"
# 12 "0_Src/AppSw/Tricore/Main/SchedulerTask.c"
...
void Task_idle (void);
# 13 "0_Src/AppSw/Tricore/Main/SchedulerTask.c" 2
...
static void Task_counter_service_1ms (void);
static void Task_counter_service_10ms (void);
static void Task_counter_service_100ms (void);
static void Task_counter_service_1000ms (void);
...
void Task_1ms (void)
{
 stm_buf = IfxStm_get(&(*(Ifx_STM *)0xF0000000u));

 ticToc_1ms_flag = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
void Task_IsrCb_1ms (void)
{
 stm_buf_1ms = IfxStm_get(&(*(Ifx_STM *)0xF0000000u));
 ...
 ticToc_1ms = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf_1ms)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
...
void Task_10ms (void)
{
 ...
 ticToc_10ms_s0 = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
void Task_10ms_slot1 (void)
{
 stm_buf = IfxStm_get(&(*(Ifx_STM *)0xF0000000u));

 ticToc_10ms_s1 = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
...
void Task_100ms_slot4(void)
{
 ...
 ticToc_100ms_s4 = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
void Task_100ms_slot14(void)
{
 stm_buf = IfxStm_get(&(*(Ifx_STM *)0xF0000000u));
 ...
 ticToc_100ms_s14 = (IfxStm_get(&(*(Ifx_STM *)0xF0000000u)) - stm_buf)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM *)0xF0000000u)));
}
